 ...
 */
class PopMessage implements ResourceInterface
{
    /**
     * Output sub-folders
     */
    const POP_SUB_FOLDER             = 'pop';
    const POP_ATTACHMENTS_SUB_FOLDER = 'attachments';
    ...
    public function moveToOutputFolder($outputFolder)
    {
        try {
            ...
            // Setting the file name (output folder + pop sub folder + current object string representation + timestamp)
    ...
    public function toString()
    {
        if (empty($this->stringRepresentation)) {
            $this->stringRepresentation = sprintf('pop_resource_%s', $this->getUniqueResourceId());
        }
        return $this->stringRepresentation;
    }

    /**
     * Returns the content file name as the concatenation of the given output folder + pop sub folder + current object string representation + timestamp.
     *
    ...
    {
        // Returning the content file name (output folder + pop sub folder + current object string representation + timestamp)
        return sprintf(
            "%s%s%s_%s",
    ...
    /**
     * Returns the content file folder as the concatenation of the given output folder + pop sub folder.
     *
    ...
    {
        // Returning the content file name (output folder + pop sub folder)
        return
    ...
    /**
     * Returns the attachment file name as the concatenation of the given output folder + pop sub folder + current object string representation + timestamp.
     *
    ...
    protected function getAttachmentFileName($originalAttachmentFileName, $baseOutputFolder)
    {
        ...
        // Returning the attachment file name (output folder + pop sub folder + pop attachment sub folder
    ...
    /**
     * Returns the attachment file folder as the concatenation of the given output folder + pop sub folder + pop attachment sub folder.
     *
     * @param string $baseOutputFolder the base output folder
     *
     * @return string
    ...
    {
        // Returning the content file name (output folder + pop sub folder + pop attachment sub folder)
        return
            rtrim($baseOutputFolder, DIRECTORY_SEPARATOR) .
            DIRECTORY_SEPARATOR .
            self::POP_SUB_FOLDER .
            DIRECTORY_SEPARATOR .
            self::POP_ATTACHMENTS_SUB_FOLDER
        ;
    }
